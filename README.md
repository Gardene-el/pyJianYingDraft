...
> 🆕 **新功能**: 现在支持通过FastAPI提供REST API接口！详见[API文档](API_README.md)
...
### REST API模式 (新)
> 🆕 通过FastAPI提供完整的REST API接口，支持通过HTTP请求操作草稿

- ☑️ 通过API创建和管理草稿
- ☑️ 通过API添加音视频、文本、贴纸片段
- ☑️ 通过API添加动画、转场、特效等
- ☑️ 查询可用的字体、动画、转场、滤镜等元数据
- ☑️ 支持多线程安全访问
- ☑️ 完整的API文档和示例

详细使用方法请参见 [API_README.md](API_README.md)
