...
class CropSettings(BaseModel):
    ...
    upper_left_x: float = Field(default=0.0, description="左上角X坐标")
    upper_left_y: float = Field(default=0.0, description="左上角Y坐标")
    upper_right_x: float = Field(default=1.0, description="右上角X坐标")
    upper_right_y: float = Field(default=0.0, description="右上角Y坐标")
    lower_left_x: float = Field(default=0.0, description="左下角X坐标")
    lower_left_y: float = Field(default=1.0, description="左下角Y坐标")
    lower_right_x: float = Field(default=1.0, description="右下角X坐标")
    lower_right_y: float = Field(default=1.0, description="右下角Y坐标")
